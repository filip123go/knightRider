...
public class ElevenByEleven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eleven_by_eleven);
    ...
    public String[] checkStartOrTarget(boolean startFlag, Boolean endFlag, int[] start, int[] target) {
        if (startFlag && endFlag) {
            ...
            Intent goToResult = new Intent(ElevenByEleven.this, ResultsActivity.class);
