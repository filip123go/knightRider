...
public class NineByNine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nine_by_nine);
    ...
    public String[] checkStartOrTarget(boolean startFlag, Boolean endFlag, int[] start, int[] target) {
        if (startFlag && endFlag) {
            ...
            Intent goToResult = new Intent(NineByNine.this, ResultsActivity.class);
