...
public class TwelveByTwelve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twelve_by_twelve);
    ...
    public String[] checkStartOrTarget(boolean startFlag, Boolean endFlag, int[] start, int[] target) {
        if (startFlag && endFlag) {
            ...
            Intent goToResult = new Intent(TwelveByTwelve.this, ResultsActivity.class);
